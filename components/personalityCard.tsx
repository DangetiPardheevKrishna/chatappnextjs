...
//       className="group relative bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 flex flex-col h-full"
//       // Implement focus card interaction: hovered card is clear, others are blurred[citation:1]
...
//       }}
//     >
//       {/* 1. Dominant Image Container - Takes ~60% of card height */}
...
//         {/* "Default" Badge - Positioned Top-Right */}
...
//         {/* Quick Action Overlay on Image Hover - Inspired by Netflix[citation:3][citation:4] */}
//         <motion.div
...
//       {/* 2. Content Section - Compact and Clean */}
...
//         {/* 3. Action Buttons - Clean and Separated */}
...
//           {/* Secondary Actions - Only for custom personalities */}
//           {!personality.isDefault && (
...
//       <motion.div
//         className="absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-cyan-200/50 pointer-events-none"
//         initial={false}
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="relative h-60 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
            {/* ... (Your existing image/avatar code remains the same) ... */}
            {/* Avatar/Image */}
            {personality.avatar ? (
              <motion.img
                src={personality.avatar}
