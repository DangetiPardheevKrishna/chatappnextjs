...
//       {/* Header */}
//       <div className="border-b border-gray-200 bg-background p-4 shadow-sm">
//         <div className="flex items-center gap-3">
//           {/* Avatar */}
...
export default function ChatWindow({
  ...
  const renderAvatar = (size = "w-10 h-10") => {
    if (avatarImage) {
      return (
        <div
          className={`${size} rounded-full overflow-hidden border border-border`}
        >
          <img
            src={avatarImage}
            alt={`${personality.name} avatar`}
            ...
            onError={(e) => {
              ...
              const parent = target.parentElement;
              if (parent) {
                parent.className = `${parent.className} flex items-center justify-center bg-gradient-to-r from-primary to-purple-600 text-primary-foreground`;
                parent.innerHTML = `
    ...
    return (
      <div
        className={`${size} rounded-full flex items-center justify-center font-semibold bg-gradient-to-r from-primary to-purple-600 text-primary-foreground`}
      >
        {personality.name.charAt(0).toUpperCase()}
      </div>
    );
  ...
  const renderAIAvatar = (size = "w-8 h-8") => {
    if (avatarImage) {
      return (
        <div
          className={`${size} rounded-full overflow-hidden border border-border shadow-sm`}
        >
          <img
            src={avatarImage}
            alt={`${personality.name} avatar`}
    ...
    return (
      <div
        className={`${size} rounded-full flex items-center justify-center text-sm font-semibold bg-gradient-to-r from-primary to-purple-600 text-primary-foreground`}
      >
        {personality.name.charAt(0).toUpperCase()}
      </div>
    );
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 ">
        {isLoadingHistory ? (
          <div className="flex flex-col items-center justify-center h-full">
            <div className="text-center">
              {/* Loading Avatar */}
              <div className="w-20 h-20 mx-auto mb-4 rounded-full overflow-hidden border-2 border-border shadow-lg animate-pulse">
                {avatarImage ? (
                  <img
                    src={avatarImage}
                    alt={`${personality.name} avatar`}
                  ...
                  <div className="w-full h-full bg-gradient-to-r from-purple-100 to-pink-100 dark:bg-accent flex items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center h-full text-center p-8">
            {/* Large Avatar for empty state */}
            <div className="w-32 h-32 mb-6 rounded-full overflow-hidden border-4 border-border shadow-lg">
              {avatarImage ? (
                <img
                  src={avatarImage}
                  alt={`${personality.name} avatar`}
            ...
            <div className="mt-8 flex flex-col gap-2 text-sm text-muted-foreground/60">
              <p>💬 Start by asking a question</p>
              <p>✨ See how {personality.name} responds in character</p>
              <p>⚡ The conversation will appear here</p>
            </div>
              ...
              >
                <p
                  className={`whitespace-pre-wrap ${
                    m.sender === "user" ? "text-white" : "text-card-foreground"
                  }`}
                >
                  {m.content}
                </p>
